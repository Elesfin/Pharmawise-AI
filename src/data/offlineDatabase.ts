...
export const OFFLINE_MEDS: Medication[] = [
  ...
  {
    name: 'Claritromicina',
    brandNames: ['Klaricid', 'Claritron'],
    laboratory: 'Abbott',
    class: 'Antibiótico (Macrolídeo)',
    indication: 'Infecções respiratórias, H. pylori, infecções de pele.',
    dosageAdult: '250mg a 500mg a cada 12h.',
    dosageChild: '7,5mg/kg a cada 12h.',
    interactions: ['Sinvastatina', 'Varfarina', 'Teofilina'],
    contraindications: ['Hipersensibilidade a macrolídeos', 'Uso de astemizol/cisaprida'],
    sideEffects: ['Gosto metálico', 'Náusea', 'Diarreia'],
    notes: 'Receita Branca 2 vias (Antibiótico).'
  },
  {
    name: 'Levofloxacino',
    ...
    laboratory: 'Sanofi',
    class: 'Antibiótico (Quinolona de 3ª Geração)',
    indication: 'Pneumonia, sinusite, infecções urinárias complexas.',
    dosageAdult: '500mg a 750mg uma vez ao dia.',
    dosageChild: 'Uso restrito.',
    interactions: ['Antiácidos', 'Corticoides (risco de ruptura de tendão)'],
    contraindications: ['Hipersensibilidade a quinolonas', 'Epilepsia'],
    sideEffects: ['Tendinite', 'Insônia', 'Diarréia'],
    notes: 'Receita Branca 2 vias. Risco de prolongamento do intervalo QT.'
  },
  {
    name: 'Ramipril',
    brandNames: ['Triatec', 'Naprix'],
    laboratory: 'Sanofi',
    class: 'Anti-hipertensivo (IECA)',
    indication: 'Hipertensão, insuficiência cardíaca, pós-infarto.',
    dosageAdult: '2,5mg a 10mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Lítio', 'AINEs', 'Suplementos de potássio'],
    contraindications: ['Gravidez', 'Histórico de angioedema'],
    sideEffects: ['Tosse seca', 'Tontura', 'Hipotensão'],
    notes: 'Efeito cardioprotetor demonstrado em estudos.'
  },
  {
    name: 'Valsartana',
    brandNames: ['Diovan', 'Brasart'],
    laboratory: 'Novartis',
    class: 'Anti-hipertensivo (BRA)',
    indication: 'Hipertensão e insuficiência cardíaca.',
    dosageAdult: '80mg a 320mg uma vez ao dia.',
    dosageChild: 'Sob orientação (acima de 6 anos).',
    interactions: ['Lítio', 'Diuréticos poupadores de potássio'],
    contraindications: ['Gravidez', 'Insuficiência hepática grave'],
    sideEffects: ['Tontura', 'Fadiga', 'Hipercalemia'],
    notes: 'Alternativa para pacientes que apresentam tosse com IECAs.'
  },
  {
    name: 'Candesartana',
    ...
    class: 'Anti-hipertensivo (BRA)',
    indication: 'Hipertensão e insuficiência cardíaca.',
    dosageAdult: '8mg a 32mg uma vez ao dia.',
    dosageChild: 'Uso restrito.',
    interactions: ['Lítio', 'AINEs', 'Espironolactona'],
    contraindications: ['Gravidez', 'Obstrução biliar'],
    sideEffects: ['Tontura', 'Cefaleia', 'Infecção respiratória'],
    notes: 'Alta afinidade pelo receptor AT1.'
  },
  {
    name: 'Empagliflozina',
    ...
    laboratory: 'Boehringer Ingelheim',
    class: 'Antidiabético (Inibidor de SGLT2)',
    indication: 'Diabetes Tipo 2 e Insuficiência Cardíaca.',
    dosageAdult: '10mg a 25mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Diuréticos', 'Insulina'],
    contraindications: ['Insuficiência renal grave (TFG < 30)'],
    sideEffects: ['Infecção urinária', 'Candidíase vaginal', 'Poliúria'],
    notes: 'Promove a excreção de glicose pela urina.'
  },
  {
    name: 'Dapagliflozina',
    brandNames: ['Forxiga'],
    ...
    dosageAdult: '10mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Insulina', 'Sulfonilureias'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Infecções genitais', 'Desidratação', 'Hipotensão'],
    notes: 'Benefício cardiovascular e renal comprovado.'
  },
  {
    name: 'Sitagliptina',
    brandNames: ['Januvia'],
    laboratory: 'MSD',
    class: 'Antidiabético (Inibidor de DPP-4)',
    indication: 'Diabetes Mellitus Tipo 2.',
    dosageAdult: '100mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Digoxina (leve aumento)'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Cefaleia', 'Nasofaringite', 'Edema periférico'],
    notes: 'Não costuma causar hipoglicemia quando usado isoladamente.'
  },
  {
    name: 'Mirtazapina',
    brandNames: ['Remeron', 'Menelat'],
    laboratory: 'Organon',
    class: 'Antidepressivo (NaSSA)',
    indication: 'Depressão maior.',
    dosageAdult: '15mg a 45mg ao dia (à noite).',
    dosageChild: 'Não recomendado.',
    interactions: ['Álcool', 'Benzodiazepínicos', 'IMAOs'],
    contraindications: ['Uso de IMAOs'],
    sideEffects: ['Sonolência intensa', 'Aumento do apetite', 'Ganho de peso'],
    notes: 'Receita C1. Muito útil em pacientes com insônia e perda de peso.'
  },
  {
    name: 'Bupropiona',
    brandNames: ['Zyban', 'Wellbutrin', 'Bup'],
    laboratory: 'GSK',
    class: 'Antidepressivo / Auxiliar na Cessação Tabágica',
    indication: 'Depressão e dependência à nicotina.',
    dosageAdult: '150mg a 300mg ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs', 'Levodopa', 'Ritonavir'],
    contraindications: ['Epilepsia', 'Anorexia/Bulimia', 'Abstinência de álcool'],
    sideEffects: ['Insônia', 'Boca seca', 'Agitação', 'Risco de convulsão (dose-dependente)'],
    notes: 'Receita C1. Pouco efeito sobre a função sexual.'
  },
  {
    name: 'Trazodona',
    brandNames: ['Donaren'],
    laboratory: 'Libbs',
    class: 'Antidepressivo (SARI)',
    indication: 'Depressão e insônia associada à depressão.',
    dosageAdult: '50mg a 150mg ao dia (pode chegar a 400mg).',
    dosageChild: 'Uso restrito.',
    interactions: ['Álcool', 'Varfarina', 'Digoxina'],
    contraindications: ['Infarto recente', 'Hipersensibilidade'],
    sideEffects: ['Sonolência', 'Tontura', 'Priapismo (raro mas grave)'],
    notes: 'Receita C1. Frequentemente usada em doses baixas para indução do sono.'
  },
  {
    name: 'Lansoprazol',
    brandNames: ['Ogastro', 'Prazol'],
    laboratory: 'Takeda',
    class: 'Inibidor da Bomba de Prótons (IBP)',
    indication: 'Úlceras, esofagite de refluxo, H. pylori.',
    dosageAdult: '15mg a 30mg uma vez ao dia em jejum.',
    dosageChild: 'Sob orientação (acima de 1 ano).',
    interactions: ['Atazanavir', 'Digoxina', 'Cetoconazol'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Diarreia', 'Náusea', 'Cefaleia'],
    notes: 'Tomar 30 min antes da refeição.'
  },
  {
    name: 'Rabeprazol',
    brandNames: ['Pariet'],
    laboratory: 'Janssen',
    class: 'Inibidor da Bomba de Prótons (IBP)',
    indication: 'Doença do refluxo, úlceras, Síndrome de Zollinger-Ellison.',
    dosageAdult: '10mg a 20mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Digoxina', 'Cetoconazol'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Cefaleia', 'Diarreia', 'Infecção respiratória'],
    notes: 'Início de ação rápido.'
  },
  {
    name: 'Celecoxibe',
    brandNames: ['Celebra'],
    laboratory: 'Pfizer',
    class: 'Anti-inflamatório (Inibidor Seletivo da COX-2)',
    indication: 'Osteoartrite, artrite reumatoide, dor aguda.',
    dosageAdult: '100mg a 200mg uma ou duas vezes ao dia.',
    dosageChild: 'Sob orientação (acima de 2 anos).',
    interactions: ['Fluconazol', 'Lítio', 'Varfarina'],
    contraindications: ['Alergia a sulfonamidas', 'Doença cardíaca isquêmica'],
    sideEffects: ['Dor abdominal', 'Edema', 'Tontura'],
    notes: 'Menor risco de úlcera gástrica que AINEs não seletivos.'
  },
  {
    name: 'Etoricoxibe',
    brandNames: ['Arcoxia'],
    laboratory: 'MSD',
    class: 'Anti-inflamatório (Inibidor Seletivo da COX-2)',
    indication: 'Artrite, gota aguda, dor musculoesquelética.',
    dosageAdult: '60mg a 120mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Varfarina', 'Rifampicina', 'Metotrexato'],
    contraindications: ['Hipertensão não controlada', 'Doença cardíaca'],
    sideEffects: ['Cefaleia', 'Palpitações', 'Aumento da pressão arterial'],
    notes: 'Uso por curto período na gota aguda (120mg).'
  }
];
...
export const OFFLINE_INTERACTIONS: Interaction[] = [
  ...
  { drugs: 'Claritromicina + Sinvastatina', level: 'Grave', effect: 'Aumento severo da concentração da estatina.', risk: 'Alto risco de rabdomiólise (lesão muscular grave).' },
  { drugs: 'Levofloxacino + Corticoides', level: 'Moderado', effect: 'Aumento do risco de ruptura de tendão.', risk: 'Lesões tendinosas, especialmente em idosos.' },
  { drugs: 'Empagliflozina + Diuréticos', level: 'Moderado', effect: 'Potencializa o efeito diurético e hipotensor.', risk: 'Risco de desidratação e hipotensão ortostática.' },
  { drugs: 'Sertralina + AINEs', level: 'Moderado', effect: 'Aumento do risco de sangramento gastrointestinal.', risk: 'Hemorragia digestiva alta.' }
];
