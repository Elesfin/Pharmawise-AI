...
export const OFFLINE_MEDS: Medication[] = [
  ...
  },
  {
    ...
    indication: 'Epilepsia, neuralgia do trigêmeo e transtorno bipolar.',
    dosageAdult: '200mg a 1200mg ao dia.',
    dosageChild: '10-20mg/kg/dia.',
    interactions: ['Anticoncepcionais', 'Varfarina', 'Eritromicina'],
    contraindications: ['Bloqueio atrioventricular', 'Histórico de depressão de medula óssea'],
    sideEffects: ['Tontura', 'Sonolência', 'Ataxia', 'Leucopenia'],
    notes: 'Receita C1 (Branca 2 vias). Potente indutor enzimático.'
  },
  {
    name: 'Ácido Valproico / Valproato de Sódio',
    brandNames: ['Depakene', 'Torval'],
    laboratory: 'Abbott',
    class: 'Anticonvulsivante / Estabilizador de Humor',
    indication: 'Epilepsia e episódios de mania no transtorno bipolar.',
    dosageAdult: '1000mg a 2000mg ao dia.',
    dosageChild: '15-60mg/kg/dia.',
    interactions: ['Fenobarbital', 'Fenitoína', 'Aspirina'],
    contraindications: ['Doença hepática grave', 'Gravidez (alto risco de teratogenia)'],
    sideEffects: ['Ganho de peso', 'Queda de cabelo', 'Náusea', 'Tremor'],
    notes: 'Receita C1 (Branca 2 vias). Monitorar função hepática.'
  },
  {
    name: 'Haloperidol',
    brandNames: ['Haldol'],
    laboratory: 'Janssen',
    class: 'Antipsicótico Típico (Neuroléptico)',
    indication: 'Esquizofrenia, agitação psicomotora, tiques (Tourette).',
    dosageAdult: '1mg a 20mg ao dia.',
    dosageChild: 'Sob orientação especialista.',
    interactions: ['Levodopa', 'Lítio', 'Álcool'],
    contraindications: ['Doença de Parkinson', 'Depressão severa do SNC'],
    sideEffects: ['Sintomas extrapiramidais (tremores, rigidez)', 'Sedação'],
    notes: 'Receita C1 (Branca 2 vias). Pode causar discinesia tardia.'
  },
  {
    name: 'Olanzapina',
    brandNames: ['Zyprexa'],
    laboratory: 'Eli Lilly',
    class: 'Antipsicótico Atípico',
    indication: 'Esquizofrenia e episódios de mania ou depressão bipolar.',
    dosageAdult: '5mg a 20mg ao dia.',
    dosageChild: 'Uso restrito.',
    interactions: ['Fluvoxamina', 'Ciprofloxacino', 'Tabagismo'],
    contraindications: ['Glaucoma de ângulo estreito'],
    sideEffects: ['Ganho de peso significativo', 'Sonolência', 'Aumento da glicemia'],
    notes: 'Receita C1 (Branca 2 vias). Alto risco metabólico.'
  },
  {
    name: 'Risperidona',
    ...
    indication: 'Esquizofrenia, irritabilidade no autismo, transtorno bipolar.',
    dosageAdult: '2mg a 6mg ao dia.',
    dosageChild: '0,25mg a 3mg ao dia (conforme indicação).',
    interactions: ['Fluoxetina', 'Paroxetina', 'Levodopa'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Ganho de peso', 'Insônia', 'Aumento da prolactina'],
    notes: 'Receita C1 (Branca 2 vias). Menor sedação que Olanzapina.'
  },
  {
    name: 'Pregabalina',
    brandNames: ['Lyrica'],
    laboratory: 'Pfizer',
    class: 'Anticonvulsivante / Analgésico Neuropático',
    indication: 'Dor neuropática, fibromialgia, transtorno de ansiedade generalizada.',
    dosageAdult: '150mg a 600mg ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Álcool', 'Lorazepam', 'Opióides'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Tontura', 'Sonolência', 'Edema periférico', 'Visão turva'],
    notes: 'Receita C1 (Branca 2 vias). Pode causar dependência.'
  },
  {
    name: 'Gabapentina',
    ...
    indication: 'Dor neuropática e epilepsia.',
    dosageAdult: '900mg a 3600mg ao dia.',
    dosageChild: 'Sob orientação.',
    interactions: ['Antiácidos (reduzem absorção)', 'Morfina'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Sonolência', 'Tontura', 'Fadiga'],
    notes: 'Receita C1 (Branca 2 vias). Ajustar dose na insuficiência renal.'
  },
  {
    name: 'Topiramato',
    brandNames: ['Topamax'],
    laboratory: 'Janssen',
    class: 'Anticonvulsivante / Profilaxia de Enxaqueca',
    indication: 'Epilepsia, prevenção de enxaqueca e perda de peso (off-label).',
    dosageAdult: '25mg a 400mg ao dia.',
    dosageChild: '1-9mg/kg/dia.',
    interactions: ['Anticoncepcionais', 'Álcool', 'Digoxina'],
    contraindications: ['Gravidez (risco de fenda palatina)'],
    sideEffects: ['Parestesia (formigamento)', 'Perda de peso', 'Dificuldade cognitiva'],
    notes: 'Receita C1 (Branca 2 vias). Beber muita água (risco de cálculo renal).'
  },
  {
    name: 'Lamotrigina',
    brandNames: ['Lamictal'],
    laboratory: 'GSK',
    class: 'Anticonvulsivante / Estabilizador de Humor',
    indication: 'Epilepsia e prevenção de episódios depressivos no transtorno bipolar.',
    dosageAdult: '100mg a 400mg ao dia.',
    dosageChild: 'Sob orientação.',
    interactions: ['Ácido Valproico (aumenta níveis)', 'Carbamazepina'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Rash cutâneo (risco de Stevens-Johnson)', 'Cefaleia', 'Tontura'],
    notes: 'Receita C1 (Branca 2 vias). Aumento de dose deve ser muito lento.'
  },
  {
    name: 'Venlafaxina',
    brandNames: ['Efexor XR'],
    laboratory: 'Pfizer',
    class: 'Antidepressivo (ISRN)',
    indication: 'Depressão, transtorno de ansiedade generalizada e pânico.',
    dosageAdult: '75mg a 225mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs', 'Outros serotoninérgicos'],
    contraindications: ['Uso de IMAOs', 'Hipertensão não controlada'],
    sideEffects: ['Náusea', 'Sudorese', 'Aumento da pressão arterial', 'Disfunção sexual'],
    notes: 'Receita C1 (Branca 2 vias). Não interromper bruscamente (síndrome de descontinuação).'
  },
  {
    name: 'Duloxetina',
    brandNames: ['Cymbalta'],
    laboratory: 'Eli Lilly',
    class: 'Antidepressivo (ISRN)',
    indication: 'Depressão, ansiedade generalizada, dor neuropática diabética e fibromialgia.',
    dosageAdult: '30mg a 60mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs', 'Fluvoxamina', 'Ciprofloxacino'],
    contraindications: ['Doença hepática', 'Insuficiência renal grave', 'Glaucoma não controlado'],
    sideEffects: ['Boca seca', 'Náusea', 'Sonolência', 'Sudorese'],
    notes: 'Receita C1 (Branca 2 vias). Eficaz em sintomas físicos de dor associados à depressão.'
  },
  {
    name: 'Desvenlafaxina',
    brandNames: ['Pristiq'],
    laboratory: 'Pfizer',
    class: 'Antidepressivo (ISRN)',
    indication: 'Transtorno depressivo maior.',
    dosageAdult: '50mg a 100mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs', 'Outros serotoninérgicos'],
    contraindications: ['Hipersensibilidade', 'Uso de IMAOs'],
    sideEffects: ['Náusea', 'Tontura', 'Insônia', 'Sudorese'],
    notes: 'Receita C1 (Branca 2 vias). Metabólito ativo da venlafaxina.'
  },
  {
    name: 'Bupropiona',
    brandNames: ['Wellbutrin', 'Zetron', 'Bup'],
    laboratory: 'GSK',
    class: 'Antidepressivo / Auxiliar na Cessação do Tabagismo',
    indication: 'Depressão e dependência à nicotina.',
    dosageAdult: '150mg a 300mg ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs', 'Levodopa', 'Ritonavir'],
    contraindications: ['Transtornos convulsivos', 'Bulimia ou anorexia nervosa'],
    sideEffects: ['Insônia', 'Boca seca', 'Cefaleia', 'Agitação'],
    notes: 'Receita C1 (Branca 2 vias). Menor risco de disfunção sexual que ISRS.'
  },
  {
    name: 'Mirtazapina',
    brandNames: ['Remeron'],
    ...
    indication: 'Transtorno depressivo maior.',
    dosageAdult: '15mg a 45mg ao dia (à noite).',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs', 'Álcool', 'Benzodiazepínicos'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Aumento de apetite', 'Ganho de peso', 'Sonolência acentuada'],
    notes: 'Receita C1 (Branca 2 vias). Útil em pacientes com insônia e perda de peso.'
  },
  {
    name: 'Citalopram',
    brandNames: ['Celexa', 'Città'],
    laboratory: 'Lundbeck',
    class: 'Antidepressivo (ISRS)',
    indication: 'Depressão e transtorno de pânico.',
    dosageAdult: '20mg a 40mg uma vez ao dia.',
    dosageChild: 'Sob orientação.',
    interactions: ['IMAOs', 'Pimozida', 'Varfarina'],
    contraindications: ['Prolongamento do intervalo QT'],
    sideEffects: ['Náusea', 'Boca seca', 'Sonolência', 'Sudorese'],
    notes: 'Receita C1 (Branca 2 vias). Similar ao Escitalopram.'
  },
  {
    name: 'Paroxetina',
    brandNames: ['Pondera', 'Paxil'],
    laboratory: 'Eurofarma',
    class: 'Antidepressivo (ISRS)',
    indication: 'Depressão, TOC, pânico, fobia social e ansiedade generalizada.',
    dosageAdult: '20mg a 50mg uma vez ao dia.',
    dosageChild: 'Uso restrito.',
    interactions: ['IMAOs', 'Triptofano', 'Varfarina'],
    contraindications: ['Uso de IMAOs', 'Tioridazina'],
    sideEffects: ['Náusea', 'Disfunção sexual', 'Sonolência', 'Astenia'],
    notes: 'Receita C1 (Branca 2 vias). Maior risco de sintomas de descontinuação.'
  },
  {
    name: 'Clomipramina',
    ...
    laboratory: 'Novartis',
    class: 'Antidepressivo Tricíclico',
    indication: 'Depressão, TOC, pânico e fobias.',
    dosageAdult: '75mg a 150mg ao dia.',
    dosageChild: 'Sob orientação (TOC).',
    interactions: ['IMAOs', 'Álcool', 'Anticolinérgicos'],
    contraindications: ['Infarto recente', 'Arritmias cardíacas'],
    sideEffects: ['Boca seca', 'Constipação', 'Visão turva', 'Ganho de peso'],
    notes: 'Receita C1 (Branca 2 vias). Padrão-ouro no tratamento do TOC.'
  },
  {
    name: 'Nortriptilina',
    brandNames: ['Pamelor'],
    laboratory: 'Eurofarma',
    class: 'Antidepressivo Tricíclico',
    indication: 'Depressão e enurese noturna.',
    dosageAdult: '25mg a 100mg ao dia.',
    dosageChild: 'Sob orientação.',
    interactions: ['IMAOs', 'Guanetidina', 'Álcool'],
    contraindications: ['Fase de recuperação pós-infarto'],
    sideEffects: ['Boca seca', 'Sonolência', 'Tontura', 'Constipação'],
    notes: 'Receita C1 (Branca 2 vias). Menos efeitos anticolinérgicos que a Amitriptilina.'
  },
  {
    name: 'Imipramina',
    brandNames: ['Tofranil'],
    laboratory: 'Novartis',
    class: 'Antidepressivo Tricíclico',
    indication: 'Depressão e enurese noturna infantil.',
    dosageAdult: '75mg a 150mg ao dia.',
    dosageChild: '10mg a 25mg (enurese).',
    interactions: ['IMAOs', 'Álcool', 'Anticolinérgicos'],
    contraindications: ['Infarto recente', 'Glaucoma'],
    sideEffects: ['Boca seca', 'Taquicardia', 'Constipação', 'Sudorese'],
    notes: 'Receita C1 (Branca 2 vias). Um dos primeiros antidepressivos desenvolvidos.'
  },
  {
    name: 'Prednisolona',
    brandNames: ['Prelone'],
    laboratory: 'Aché',
    class: 'Corticoide Oral',
    indication: 'Processos inflamatórios e alérgicos, doenças autoimunes.',
    dosageAdult: '5mg a 60mg ao dia.',
    dosageChild: '0,14mg a 2mg/kg/dia.',
    interactions: ['Antidiabéticos', 'AINEs', 'Vacinas'],
    contraindications: ['Infecções fúngicas sistêmicas'],
    sideEffects: ['Aumento de apetite', 'Retenção de líquidos', 'Gastrite', 'Insônia'],
    notes: 'Forma ativa da Prednisona (melhor para pacientes com insuficiência hepática).'
  },
  {
    name: 'Dexametasona',
    brandNames: ['Decadron'],
    laboratory: 'Aché',
    class: 'Corticoide Potente',
    indication: 'Inflamações severas, edema cerebral, náuseas pós-quimio.',
    dosageAdult: '0,75mg a 9mg ao dia.',
    dosageChild: '0,02mg a 0,3mg/kg/dia.',
    interactions: ['Fenitoína', 'Rifampicina', 'Antidiabéticos'],
    contraindications: ['Infecções fúngicas', 'Vacinas de vírus vivo'],
    sideEffects: ['Aumento da glicemia', 'Insônia', 'Retenção de sódio'],
    notes: 'Corticoide de longa duração e alta potência anti-inflamatória.'
  },
  {
    name: 'Betametasona',
    brandNames: ['Celestone'],
    laboratory: 'Mantecorp',
    class: 'Corticoide Potente',
    indication: 'Doenças reumáticas, alérgicas e dermatológicas.',
    dosageAdult: '0,6mg a 7,2mg ao dia.',
    dosageChild: '0,02mg a 0,25mg/kg/dia.',
    interactions: ['Fenobarbital', 'Efedrina', 'Estrogênios'],
    contraindications: ['Infecções sistêmicas por fungos'],
    sideEffects: ['Fraqueza muscular', 'Osteoporose (uso longo)', 'Catarata'],
    notes: 'Potência similar à Dexametasona.'
  },
  {
    name: 'Clonidina',
    brandNames: ['Atensina'],
    laboratory: 'Boehringer Ingelheim',
    class: 'Anti-hipertensivo (Agonista Alfa-2 Central)',
    indication: 'Hipertensão arterial e crises hipertensivas.',
    dosageAdult: '0,1mg a 0,6mg ao dia.',
    dosageChild: 'Uso restrito.',
    interactions: ['Betabloqueadores', 'Antidepressivos Tricíclicos'],
    contraindications: ['Bradicardia severa'],
    sideEffects: ['Boca seca', 'Sonolência', 'Tontura', 'Constipação'],
    notes: 'Não interromper bruscamente (risco de hipertensão de rebote).'
  },
  {
    name: 'Metildopa',
    brandNames: ['Aldomet'],
    laboratory: 'Aspen',
    class: 'Anti-hipertensivo (Agonista Alfa-2 Central)',
    indication: 'Hipertensão arterial, especialmente na gravidez.',
    dosageAdult: '250mg a 2000mg ao dia.',
    dosageChild: '10mg a 65mg/kg/dia.',
    interactions: ['Lítio', 'Inibidores da MAO', 'Ferro'],
    contraindications: ['Doença hepática ativa'],
    sideEffects: ['Sedação', 'Boca seca', 'Edema', 'Anemia hemolítica (raro)'],
    notes: 'Medicamento de escolha para hipertensão na gestação.'
  },
  {
    name: 'Hidralazina',
    brandNames: ['Apresolina'],
    laboratory: 'Novartis',
    class: 'Anti-hipertensivo (Vasodilatador Direto)',
    indication: 'Hipertensão moderada a grave e insuficiência cardíaca.',
    dosageAdult: '50mg a 200mg ao dia.',
    dosageChild: '0,75mg a 7,5mg/kg/dia.',
    interactions: ['Outros anti-hipertensivos', 'IMAOs'],
    contraindications: ['Lúpus Eritematoso Sistêmico', 'Taquicardia severa'],
    sideEffects: ['Cefaleia', 'Taquicardia', 'Palpitações', 'Lúpus induzido por drogas'],
    notes: 'Frequentemente usada em combinação com nitratos na insuficiência cardíaca.'
  },
  {
    name: 'Isossorbida (Dinitrato/Mononitrato)',
    brandNames: ['Isordil', 'Monocordil'],
    laboratory: 'Sigma Pharma',
    class: 'Vasodilatador Coronariano (Nitrato)',
    indication: 'Angina de peito e insuficiência cardíaca.',
    dosageAdult: '10mg a 120mg ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Sildenafila (CONTRAINDICADO - Risco de morte)', 'Álcool'],
    contraindications: ['Hipotensão grave', 'Choque', 'Anemia grave'],
    sideEffects: ['Cefaleia (muito comum)', 'Hipotensão ortostática', 'Rubor'],
    notes: 'Pode ocorrer tolerância aos nitratos (necessário período livre da droga).'
  },
  {
    name: 'Apixabana',
    brandNames: ['Eliquis'],
    ...
    class: 'Anticoagulante (Inibidor do Fator Xa)',
    indication: 'Prevenção de AVC em fibrilação atrial e tratamento de TVP/EP.',
    dosageAdult: '2,5mg a 5mg duas vezes ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Cetoconazol', 'Ritonavir', 'AINEs', 'Aspirina'],
    contraindications: ['Sangramento ativo', 'Doença hepática com coagulopatia'],
    sideEffects: ['Sangramentos', 'Anemia', 'Náusea'],
    notes: 'Não requer monitoramento de RNI. Ajustar dose em idosos/insuficiência renal.'
  },
  {
    name: 'Dabigatrana',
    brandNames: ['Pradaxa'],
    laboratory: 'Boehringer Ingelheim',
    class: 'Anticoagulante (Inibidor Direto da Trombina)',
    indication: 'Prevenção de AVC em fibrilação atrial e tratamento de TVP/EP.',
    dosageAdult: '110mg a 150mg duas vezes ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Amiodarona', 'Verapamil', 'Quinidina'],
    contraindications: ['Insuficiência renal grave (ClCr < 30)', 'Sangramento ativo'],
    sideEffects: ['Dispepsia (dor de estômago)', 'Sangramentos', 'Gastrite'],
    notes: 'Cápsulas não devem ser abertas. Possui antídoto específico (Idarucizumabe).'
  },
  {
    name: 'Enoxaparina',
    brandNames: ['Clexane'],
    laboratory: 'Sanofi',
    class: 'Anticoagulante (Heparina de Baixo Peso Molecular)',
    indication: 'Prevenção e tratamento de trombose venosa profunda e infarto.',
    dosageAdult: '40mg (prevenção) ou 1mg/kg 12/12h (tratamento).',
    dosageChild: 'Uso hospitalar.',
    interactions: ['AINEs', 'Antiagregantes plaquetários'],
    contraindications: ['Sangramento ativo', 'Trombocitopenia induzida por heparina'],
    sideEffects: ['Hematoma no local da aplicação', 'Sangramentos', 'Trombocitopenia'],
    notes: 'Administração via subcutânea. Não requer monitoramento de rotina do TAP/TTPa.'
  },
  {
    name: 'Levodopa + Carbidopa',
    brandNames: ['Sinemet', 'Cronomet'],
    laboratory: 'MSD',
    class: 'Antiparkinsoniano (Precursor de Dopamina)',
    indication: 'Doença de Parkinson.',
    dosageAdult: 'Ajuste individualizado.',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs não seletivos', 'Ferro', 'Proteínas na dieta'],
    contraindications: ['Glaucoma de ângulo estreito', 'Lesões de pele suspeitas'],
    sideEffects: ['Discinesias (movimentos involuntários)', 'Náusea', 'Hipotensão'],
    notes: 'A carbidopa evita a degradação periférica da levodopa.'
  },
  {
    name: 'Levodopa + Benserazida',
    brandNames: ['Prolopa'],
    ...
    dosageAdult: 'Ajuste individualizado.',
    dosageChild: 'Não recomendado.',
    interactions: ['IMAOs', 'Neurolépticos', 'Ferro'],
    contraindications: ['Hipersensibilidade', 'Menores de 25 anos'],
    sideEffects: ['Arritmias', 'Náusea', 'Movimentos involuntários'],
    notes: 'Tomar preferencialmente 30 min antes ou 1h após as refeições.'
  },
  {
    name: 'Pramipexol',
    brandNames: ['Sifrol'],
    laboratory: 'Boehringer Ingelheim',
    class: 'Antiparkinsoniano (Agonista Dopaminérgico)',
    indication: 'Doença de Parkinson e Síndrome das Pernas Inquietas.',
    dosageAdult: '0,375mg a 4,5mg ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Cimetidina', 'Amantadina'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Sonolência súbita', 'Alucinações', 'Náusea', 'Compulsões'],
    notes: 'Pode causar ataques de sono durante o dia.'
  },
  {
    name: 'Biperideno',
    brandNames: ['Akineton'],
    ...
    indication: 'Parkinsonismo e sintomas extrapiramidais induzidos por neurolépticos.',
    dosageAdult: '2mg a 12mg ao dia.',
    dosageChild: 'Sob orientação.',
    interactions: ['Antihistamínicos', 'Quinidina'],
    contraindications: ['Glaucoma de ângulo estreito', 'Megacólon'],
    sideEffects: ['Boca seca', 'Visão turva', 'Constipação', 'Confusão mental'],
    notes: 'Receita C1 (Branca 2 vias). Útil para reduzir tremores e rigidez.'
  },
  {
    name: 'Donepezila',
    brandNames: ['Ericept', 'Donila'],
    laboratory: 'Pfizer',
    class: 'Antidistônico / Inibidor da Acetilcolinesterase',
    indication: 'Doença de Alzheimer (leve a grave).',
    dosageAdult: '5mg a 10mg uma vez ao dia (à noite).',
    dosageChild: 'Não recomendado.',
    interactions: ['Cetoconazol', 'Quinidina', 'AINEs'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Diarreia', 'Náusea', 'Insônia', 'Cãibras'],
    notes: 'Melhora a função cognitiva e atividades da vida diária.'
  },
  {
    name: 'Galantamina',
    brandNames: ['Reminyl ER'],
    laboratory: 'Janssen',
    class: 'Inibidor da Acetilcolinesterase',
    indication: 'Doença de Alzheimer (leve a moderada).',
    dosageAdult: '8mg a 24mg uma vez ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Paroxetina', 'Eritromicina', 'Cetoconazol'],
    contraindications: ['Insuficiência hepática ou renal grave'],
    sideEffects: ['Náusea', 'Vômitos', 'Diminuição do apetite'],
    notes: 'Cápsulas de liberação prolongada devem ser tomadas pela manhã.'
  },
  {
    name: 'Memantina',
    brandNames: ['Ebix', 'Alois'],
    laboratory: 'Lundbeck',
    class: 'Antagonista do Receptor NMDA',
    indication: 'Doença de Alzheimer (moderada a grave).',
    dosageAdult: '5mg a 20mg ao dia.',
    dosageChild: 'Não recomendado.',
    interactions: ['Amantadina', 'Cetamina', 'Dextrometorfano'],
    contraindications: ['Hipersensibilidade'],
    sideEffects: ['Tontura', 'Cefaleia', 'Constipação', 'Sonolência'],
    notes: 'Pode ser usada em combinação com inibidores da acetilcolinesterase.'
  },
  {
    name: 'Rivastigmina',
    brandNames: ['Exelon', 'Prometax'],
    laboratory: 'Novartis',
    class: 'Inibidor da Acetilcolinesterase',
    indication: 'Doença de Alzheimer e demência no Parkinson.',
    dosageAdult: '3mg a 12mg ao dia (oral) ou adesivo transdérmico.',
    dosageChild: 'Não recomendado.',
    interactions: ['Metoclopramida', 'Betabloqueadores'],
    contraindications: ['Insuficiência hepática grave'],
    sideEffects: ['Náusea', 'Vômitos', 'Perda de peso', 'Tontura'],
    notes: 'O adesivo transdérmico (patch) reduz significativamente os efeitos colaterais TGI.'
  }
];
